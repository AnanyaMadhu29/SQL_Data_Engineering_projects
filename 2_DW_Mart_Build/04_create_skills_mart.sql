...
SELECT '=== Loading Date Month Dimension ===' AS info;
...
SELECT '=== Loading Fact Skill Demand Monthly ===' AS info;
...
UNION ALL
SELECT 'Fact Skill Demand Monthly' AS table_name, count(*) AS record_count FROM skills_mart.fact_skill_demand_monthly;
