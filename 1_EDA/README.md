...
An end-to-end SQL project focused on analyzing the data engineering job market using real-world job posting datasets. It highlights my expertise in **crafting production-quality analytical SQL, optimizing query performance, and deriving meaningful insights from business-driven questions.**
...
3. [Optimal Skills](03_optimal_skills.sql) – combined demand/salary optimization query.
...
![Database Overview](../Images/1_2_Data_Warehouse.png)
...
- **Conditional Logics:** `CASE WHEN` statements for derived metrics
